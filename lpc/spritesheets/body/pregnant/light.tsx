...
<tileset version="1.2" tiledversion="1.2.0" name="light" tilewidth="64" tileheight="64" tilecount="120" columns="10">
 <properties>
  <property name="author" value="elizawy"/>
  <property name="category" value="body;pregnant"/>
